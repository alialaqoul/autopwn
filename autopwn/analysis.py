...
_STEP_SIGNALS = {
    ...
    # hydra SSH success: "[22][ssh] host: X login: Y password: Z"
    "ssh_cred": [r"\[\d+\]\[ssh\][^\n]*login:", r"\[ssh\][^\n]*password:"],
    ...
    "sccm": [r"Management Point", r"Distribution Point", r"Site Code\s*:",
             r"Found SCCM", r"Primary Site", r"System Management", r"NAA "],
...
_ARTIFACT_ORDER = ["admin", "flag", "golden", "certighost", "certificate", "ssh_cred",
